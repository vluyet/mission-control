...
- Added an `openclaw-connector` service to the production compose stack so Mission Control can target OpenClaw through an in-stack hostname
- Updated OpenClaw workspace configuration guidance to prefer `http://openclaw-connector:18790` in Docker deployments
