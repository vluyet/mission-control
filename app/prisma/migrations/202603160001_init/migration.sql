-- CreateEnum
CREATE TYPE "WorkspaceVisibility" AS ENUM ('personal', 'shared');

-- CreateEnum
CREATE TYPE "MemberKind" AS ENUM ('human', 'agent');
...
-- CreateIndex
CREATE INDEX "Membership_workspaceId_kind_enabled_idx" ON "Membership"("workspaceId", "kind", "enabled");
