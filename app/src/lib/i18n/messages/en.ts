...
export const en: Messages = {
  ...
  auth: {
    ...
    environmentAccess: 'Environment-backed owner access',
    submit: 'Continue to workspace',
    submitting: 'Signing in...',
    localOwnerAccess: 'Local owner access is configured through environment variables.',
    dockerWorkflow: 'Docker-only workflow',
