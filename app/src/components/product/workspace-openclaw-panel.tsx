    ...
    <Panel className="overflow-hidden">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 px-5 py-5">
        ...
        <div>
          ...
          <input name="baseUrl" defaultValue={integration?.baseUrl ?? ""} placeholder="http://openclaw-connector:18790" className="input-control mt-2" />
        </div>
        ...
        <div>
          ...
          <p className="mt-2 text-xs text-[var(--text-dim)]">
            Used for authenticated agent discovery. In Docker deployments, prefer http://openclaw-connector:18790. Leave blank to keep the currently saved token.
          </p>
        </div>
